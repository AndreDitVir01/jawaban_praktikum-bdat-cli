...
--BEGIN
--add_job('IT_2D3B', 'Deny Herianto');
--END;
--/

--SELECT * FROM jobs WHERE job_id='IT_2D3B';

--2)
--SET SERVEROUTPUT ON
--CREATE OR REPLACE PROCEDURE upd_job(kode jobs.job_id%TYPE, job_name jobs.job_title%TYPE) IS
--null_ex EXCEPTION;
--BEGIN
...
--BEGIN
--upd_job('IT_DOC', 'Doc Administrator');
--END;
--/